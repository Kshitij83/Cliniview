  ...
  useEffect(() => {
    ...
    const mockNotifications: Notification[] = [
      ...
      },
      {
        ...
        message: 'Your insurance claim for ₹1,500.00 has been approved and will be processed within 5-7 business days.',
        type: 'success',
        read: true,
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 placeholder:text-gray-400"
                />
              </div>
            </div>
